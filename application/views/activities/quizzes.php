...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="<?php echo site_url('activities/quizzes'); ?>" method="post" enctype="multipart/form-data">	
      ...
      <div class="modal-body">        
		<table class="table" style="width: 600px; margin: 0px;">
			...
			<tr>
				<td>Option C<br/><i><small>*optional</small></i></td>
				<td>
					<input type="text" class="form-control" name="options[2]"/>
				</td>
			</tr>			
			<tr>
				<td>Option D<br/><i><small>*optional</small></i></td>
				<td>
					<input type="text" class="form-control" name="options[3]"/>
				</td>
			</tr>						
			<tr>
				<td>Answer<br/><i><small>*optional</small></i></td>
				<td>
					<select name="answer">
